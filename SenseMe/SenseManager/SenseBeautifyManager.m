...
- (void)initBeautyValues {
    ...
    self.fChinStrength = 2.0;
    self.fHairLineStrength = 2.0;
    self.fNarrowNoseStrength = 2.0;
    self.fLongNoseStrength = 2.0;
    self.fMouthStrength = 2.0;
    self.fPhiltrumStrength = 2.0;
    
    self.fEyeDistanceStrength = 2.0;
    self.fEyeAngleStrength = 2.0;
    self.fOpenCanthusStrength = 2.0;
    self.fProfileRhinoplastyStrength = 2.0;
    self.fBrightEyeStrength = 2.0;
    self.fRemoveDarkCirclesStrength = 2.0;
    self.fRemoveNasolabialFoldsStrength = 2.0;
    self.fWhiteTeethStrength = 2.0;
    self.fAppleMusleStrength = 2.0;
    
    self.fContrastStrength = 2.0;
    self.fSaturationStrength = 2.0;
