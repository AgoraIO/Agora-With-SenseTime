...
typedef struct st_mobile_attr_face_hair_girl_info{
	...
	enum hair_girl_buckle_t{
		...
		HAIR_BUCKLE_BRAID,					///< 辫子
	} buckle;									///< 头发类型
	enum hair_girl_length_t{
		HAIR_LENGTH_NONE = 0,				///< 无头发
		HAIR_LENGTH_SHORT,					///< 短头发(发不过肩胛骨)
		HAIR_LENGTH_LONG,					///< 长头发(可能超出图片)
		HAIR_LENGTH_SINGLE_HORSETAIL,		///< 单马尾
		HAIR_LENGTH_DOUBLE_HORSETAIL,		///< 双马尾
		HAIR_LENGTH_SINGLE_BALL,			///< 单丸子
		HAIR_LENGTH_DOUBLE_BALL,			///< 双丸子
	} length;									///< 头发长度
