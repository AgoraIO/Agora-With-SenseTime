...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.item < self.allArray.count) {
        ...
        model.currentIndexPath = [NSIndexPath indexPathForRow:self.allArray.count - indexPath.row - 1 inSection:indexPath.section];
    }
...
- (void)photoViewCell:(HXPhotoViewCell *)cell didSelectBtn:(UIButton *)selectBtn { // MARK: 选中图片
