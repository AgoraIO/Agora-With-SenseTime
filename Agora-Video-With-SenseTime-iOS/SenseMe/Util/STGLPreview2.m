...
- (void)renderTexture:(GLuint)texture rotate:(st_rotate_type)rotateType
{
    if ([EAGLContext setCurrentContext:self.glContext]) {
        ...
        [self drawFrameWithTexture:texture rotate:rotateType];
    }
}

- (BOOL)drawFrameWithTexture:(GLuint)texture rotate:(st_rotate_type)rotateType
{
    ...
    if (rotateType == ST_CLOCKWISE_ROTATE_0) {
        glVertexAttribPointer(ATTRIB_TEXTUREPOSITON, 2, GL_FLOAT, 0, 0, textureVerticesRotate0);
    } else if (rotateType == ST_CLOCKWISE_ROTATE_90) {
        glVertexAttribPointer(ATTRIB_TEXTUREPOSITON, 2, GL_FLOAT, 0, 0, textureVerticesRotate90);
    } else if (rotateType == ST_CLOCKWISE_ROTATE_180) {
        glVertexAttribPointer(ATTRIB_TEXTUREPOSITON, 2, GL_FLOAT, 0, 0, textureVerticesRotate180);
    } else {
        glVertexAttribPointer(ATTRIB_TEXTUREPOSITON, 2, GL_FLOAT, 0, 0, textureVerticesRotate270);
    }
