...
@protocol EFCommonObjectViewDelegate<NSObject>
...
@interface EFCommonObjectView : UIView
...
@property (nonatomic, readwrite, weak) id<EFCommonObjectViewDelegate> delegate;
