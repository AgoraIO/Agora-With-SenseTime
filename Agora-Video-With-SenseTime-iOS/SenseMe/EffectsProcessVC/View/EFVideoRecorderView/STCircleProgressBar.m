...
#define DefaultProgressBarTrackColor [UIColor colorWithRed:212.0/255.0 green:146.0/255.0 blue:1.0 alpha:1.0]
#define DefaultProgressBarProgressColor [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:1.0]
const CGFloat DefaultProgressBarWidth = 5.0f;

// Hint View Defaults
#define DefaultHintBackgroundColor [UIColor colorWithRed:0 green:0 blue:1 alpha:0.7]
#define DefaultHintTextFont [UIFont fontWithName:@"HelveticaNeue-CondensedBlack" size:30.0f]
#define DefaultHintTextColor [UIColor colorWithRed:0 green:0 blue:1 alpha:0.7]//[UIColor whiteColor]
...
@interface STCircleProgressBar (Private)
...
@implementation STCircleProgressBar {
...
@implementation STCircleProgressBar (Private)
...
- (void)drawBackground:(CGContextRef)context {
    //UIColor *bg = [[UIColor alloc]initWithRed:0 green:0 blue:0 alpha:0];
...
//    //CGContextAddEllipseInRect(context, _rect);
...
- (void)drawSimpleHintTextAtCenter:(CGPoint)center {
    ...
    [progressString drawAtPoint:CGPointMake(center.x - hintTextSize.width / 2, center.y + self.bounds.size.height / 2 - 30/*- hintTextSize.height / 2*/) withAttributes:@{NSFontAttributeName: self.hintTextFontForDrawing, NSForegroundColorAttributeName: self.hintTextColorForDrawing}];
}
