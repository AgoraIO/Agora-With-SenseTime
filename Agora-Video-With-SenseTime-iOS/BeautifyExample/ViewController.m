...
#pragma mark Capturer
{
    ...
    rect = [SenseTimeUtil getZoomedRectWithRect:rect scaleToFit:NO videoSettingSize:CGSizeMake(320, 480)];
...
- (void)changeResolution640x480 {
    ...
    // 640x480
    if (self.cameraCapturer.sessionPreset != AVCaptureSessionPreset640x480) {
        [self.senseEffectsView resetCommonObjectViewPosition];
        [self.cameraCapturer setSessionPreset:AVCaptureSessionPreset640x480];
    }
    self.pauseOutput = NO;
}
...
- (void)changeResolution1280x720 {
    ...
    if (self.cameraCapturer.sessionPreset != AVCaptureSessionPreset1280x720) {
        [self.senseEffectsView resetCommonObjectViewPosition];
        [self.cameraCapturer setSessionPreset:AVCaptureSessionPreset1280x720];
    }
