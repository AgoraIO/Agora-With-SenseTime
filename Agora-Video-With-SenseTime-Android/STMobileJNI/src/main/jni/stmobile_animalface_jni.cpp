...
extern "C" {
    ...
    JNIEXPORT jint JNICALL Java_com_sensetime_stmobile_STMobileAnimalNative_addSubModel(JNIEnv * env, jobject obj, jstring modelpath);
    JNIEXPORT jint JNICALL Java_com_sensetime_stmobile_STMobileAnimalNative_addSubModelFromAssetFile(JNIEnv * env, jobject obj, jstring model_path, jobject assetManager);
};
                                                                                                   ...
                                                                                                   jint rotate, jint detectConfig, jint imageWidth, jint imageHeight)
{
    ...
    if(animalhandle != NULL)
    {
        ...
        result =  st_mobile_tracker_animal_face_track(animalhandle, (unsigned char *)srcdata,  (st_pixel_format)imageFormat,  imageWidth,
                                                imageHeight, image_stride, (st_rotate_type)rotate, detectConfig, &animal_face, &animal_face_count);
    ...
    LOGE("the animal face count is %d", animal_face_count);
